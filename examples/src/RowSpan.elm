module RowSpan exposing (Model, init, view)
...
view : Model -> Html ()
view model =
    Components.viewPage { headline = "Row Span", pageUrl = "https://github.com/mercurymedia/elm-ag-grid/blob/main/examples/src/RowSpan.elm" }
        [ div [] [ text "Rows can be spanned programmatically by setting the spanRows property on the ColumnSettings." ]
        , viewGrid model
        ]
    ...
    let
        ...
        columns =
            ...
            , AgGrid.Column
                ...
                , headerName = "Country"
                , settings = { gridSettings | spanRows = True, sort = AgGrid.SortAscending, sortable = False }
                }
            , AgGrid.Column
                { field = "year"
